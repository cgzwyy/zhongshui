...
public class RiseNumberTextView extends TextView implements IRaiseNumber {
    ...
    public RiseNumberTextView(Context context, AttributeSet attr) {
        super(context, attr);
//        setTextColor(context.getResources().getColor(R.color.turquoise));
//        setTextSize(context.getResources().getDimension(R.dimen.big_big_text_size));
    }
